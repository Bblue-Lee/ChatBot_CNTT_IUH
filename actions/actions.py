...
class ActionGetInfo_DoiNguGV_KTPM(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
            tracker: Tracker,
            domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        file=pandas.read_csv('E:\\ChatBot-CNTT\\actions\\KTPM_GV.csv')
...
class ActionGetInfo_DoiNguGV_KHMT(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
            tracker: Tracker,
            domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        file=pandas.read_csv('E:\\ChatBot-CNTT\\actions\\KHMT_GV.csv')
...
class ActionGetInfo_DoiNguGV_KHDL(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
            tracker: Tracker,
            domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        file=pandas.read_csv('E:\\ChatBot-CNTT\\actions\\KHDL_GV.csv')
...
class ActionGetInfo_DoiNguGV_CNTT(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
            tracker: Tracker,
            domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        file=pandas.read_csv('E:\\ChatBot-CNTT\\actions\\CNTT_GV.csv')
...
class ActionGetInfo_DoiNguGV_HTTT(Action):
    ...
    def run(self, dispatcher: CollectingDispatcher,
            tracker: Tracker,
            domain: Dict[Text, Any]) -> List[Dict[Text, Any]]:
        file=pandas.read_csv('E:\\ChatBot-CNTT\\actions\\HTTT_GV.csv')
